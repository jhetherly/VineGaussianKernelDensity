...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            ...
            "VineGaussianKernelDensity/WeightedGaussKDE_KD_Tree.hpp"
        ], 
        "include_dirs": [
            "//anaconda/lib/python2.7/site-packages/numpy/core/include", 
            "VineGaussianKernelDensity", 
    ...
    "module_name": "VineGaussianKernelDensity.compiled_utilities"
}
END: Cython Metadata */
...
#define __PYX_HAVE__VineGaussianKernelDensity__compiled_utilities
#define __PYX_HAVE_API__VineGaussianKernelDensity__compiled_utilities
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
#include "numpy/arrayobject.h"
#include "numpy/ufuncobject.h"
#include "WeightedGaussKDE_KD_Tree.hpp"
#include "ios"
#include "new"
#include "stdexcept"
#include "typeinfo"
...
/*--- Type declarations ---*/
struct __pyx_obj_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D;
...
/* "VineGaussianKernelDensity/compiled_utilities.pyx":47
...
struct __pyx_obj_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D {
  PyObject_HEAD
  WeightedGaussKDE_KD_Tree_1D *c_wgkde;
};
...
/* Module declarations from 'VineGaussianKernelDensity.compiled_utilities' */
static PyTypeObject *__pyx_ptype_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D = 0;
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "VineGaussianKernelDensity.compiled_utilities"
int __pyx_module_is_main_VineGaussianKernelDensity__compiled_utilities = 0;

/* Implementation of 'VineGaussianKernelDensity.compiled_utilities' */
...
static const char __pyx_k_max_var[] = "max_var";
static const char __pyx_k_weights[] = "weights";
static const char __pyx_k_max_leaf[] = "max_leaf";
...
static PyObject *__pyx_n_s_max_leaf;
static PyObject *__pyx_n_s_max_var;
...
static int __pyx_pf_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D___cinit__(struct __pyx_obj_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D *__pyx_v_self, unsigned int __pyx_v_max_leaf); /* proto */
static void __pyx_pf_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_2__dealloc__(struct __pyx_obj_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_4SetPointsAndWeights(struct __pyx_obj_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D *__pyx_v_self, PyArrayObject *__pyx_v_points, PyArrayObject *__pyx_v_weights, PyArrayObject *__pyx_v_max_var, double __pyx_v_tol); /* proto */
static PyObject *__pyx_pf_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_6SetPointsAndWeights(struct __pyx_obj_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D *__pyx_v_self, PyArrayObject *__pyx_v_points, PyArrayObject *__pyx_v_weights, double __pyx_v_max_var, double __pyx_v_tol); /* proto */
static int __pyx_pf_5numpy_7ndarray___getbuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info, int __pyx_v_flags); /* proto */
static void __pyx_pf_5numpy_7ndarray_2__releasebuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info); /* proto */
static PyObject *__pyx_tp_new_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
/* "VineGaussianKernelDensity/compiled_utilities.pyx":50
 *     # hold a pointer to the C++ instance which we're wrapping
 *     cdef WeightedGaussKDE_KD_Tree_1D* c_wgkde
...
/* Python wrapper */
static int __pyx_pw_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  unsigned int __pyx_v_max_leaf;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__cinit__ (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_max_leaf,0};
    PyObject* values[1] = {0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_max_leaf)) != 0)) kw_args--;
    ...
    __pyx_v_max_leaf = __Pyx_PyInt_As_unsigned_int(values[0]); if (unlikely((__pyx_v_max_leaf == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 50, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 1, 1, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 50, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("VineGaussianKernelDensity.compiled_utilities.PyWeightedGaussKDE_KD_Tree_1D.__cinit__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D___cinit__(((struct __pyx_obj_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D *)__pyx_v_self), __pyx_v_max_leaf);
...
static int __pyx_pf_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D___cinit__(struct __pyx_obj_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D *__pyx_v_self, unsigned int __pyx_v_max_leaf) {
  int __pyx_r;
  __Pyx_TraceDeclarations
  __Pyx_RefNannyDeclarations
  WeightedGaussKDE_KD_Tree_1D *__pyx_t_1;
  __Pyx_RefNannySetupContext("__cinit__", 0);
  __Pyx_TraceCall("__cinit__", __pyx_f[0], 50, 0, __PYX_ERR(0, 50, __pyx_L1_error));

  /* "VineGaussianKernelDensity/compiled_utilities.pyx":51
 *     cdef WeightedGaussKDE_KD_Tree_1D* c_wgkde
 *     def __cinit__(self, const unsigned int &max_leaf):
 *         self.c_wgkde = new WeightedGaussKDE_KD_Tree_1D(max_leaf)             # <<<<<<<<<<<<<<
 *     def __dealloc__(self):
 ...
 */
  try {
    __pyx_t_1 = new WeightedGaussKDE_KD_Tree_1D(__pyx_v_max_leaf);
  } catch(...) {
    __Pyx_CppExn2PyErr();
    __PYX_ERR(0, 51, __pyx_L1_error)
  }
  __pyx_v_self->c_wgkde = __pyx_t_1;
...
/* "VineGaussianKernelDensity/compiled_utilities.pyx":52
 *     def __cinit__(self, const unsigned int &max_leaf):
 *         self.c_wgkde = new WeightedGaussKDE_KD_Tree_1D(max_leaf)
 *     def __dealloc__(self):             # <<<<<<<<<<<<<<
 *         del self.c_wgkde
...
/* Python wrapper */
static void __pyx_pw_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_3__dealloc__(PyObject *__pyx_v_self); /*proto*/
static void __pyx_pw_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_3__dealloc__(PyObject *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__ (wrapper)", 0);
  __pyx_pf_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_2__dealloc__(((struct __pyx_obj_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D *)__pyx_v_self));

  /* function exit code */
  __Pyx_RefNannyFinishContext();
}

static void __pyx_pf_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_2__dealloc__(struct __pyx_obj_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D *__pyx_v_self) {
  __Pyx_TraceDeclarations
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__", 0);
  __Pyx_TraceCall("__dealloc__", __pyx_f[0], 52, 0, __PYX_ERR(0, 52, __pyx_L1_error));

  /* "VineGaussianKernelDensity/compiled_utilities.pyx":53
 *         self.c_wgkde = new WeightedGaussKDE_KD_Tree_1D(max_leaf)
 *     def __dealloc__(self):
 *         del self.c_wgkde             # <<<<<<<<<<<<<<
 *     def SetPointsAndWeights(self,
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("VineGaussianKernelDensity.compiled_utilities.PyWeightedGaussKDE_KD_Tree_1D.__dealloc__", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_L0:;
  __Pyx_TraceReturn(Py_None, 0);
  __Pyx_RefNannyFinishContext();
}

/* "VineGaussianKernelDensity/compiled_utilities.pyx":54
 *     def __dealloc__(self):
 *         del self.c_wgkde
 *     def SetPointsAndWeights(self,             # <<<<<<<<<<<<<<
 *                             np.ndarray[double, ndim=1, mode='c'] points,
...
/* Python wrapper */
static PyObject *__pyx_pw_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_5SetPointsAndWeights(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_4SetPointsAndWeights[] = "PyWeightedGaussKDE_KD_Tree_1D.SetPointsAndWeights(self, ndarray points, ndarray weights, ndarray max_var, double tol=1e-08)";
static PyObject *__pyx_pw_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_5SetPointsAndWeights(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_points = 0;
  PyArrayObject *__pyx_v_weights = 0;
  PyArrayObject *__pyx_v_max_var = 0;
  double __pyx_v_tol;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("SetPointsAndWeights (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_points,&__pyx_n_s_weights,&__pyx_n_s_max_var,&__pyx_n_s_tol,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_weights)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("SetPointsAndWeights", 0, 3, 4, 1); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_max_var)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("SetPointsAndWeights", 0, 3, 4, 2); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        case  3:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "SetPointsAndWeights") < 0)) __PYX_ERR(0, 54, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_max_var = ((PyArrayObject *)values[2]);
    if (values[3]) {
      __pyx_v_tol = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_tol == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 58, __pyx_L3_error)
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("SetPointsAndWeights", 0, 3, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 54, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("VineGaussianKernelDensity.compiled_utilities.PyWeightedGaussKDE_KD_Tree_1D.SetPointsAndWeights", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_points), __pyx_ptype_5numpy_ndarray, 1, "points", 0))) __PYX_ERR(0, 55, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_weights), __pyx_ptype_5numpy_ndarray, 1, "weights", 0))) __PYX_ERR(0, 56, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_max_var), __pyx_ptype_5numpy_ndarray, 1, "max_var", 0))) __PYX_ERR(0, 57, __pyx_L1_error)
  __pyx_r = __pyx_pf_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_4SetPointsAndWeights(((struct __pyx_obj_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D *)__pyx_v_self), __pyx_v_points, __pyx_v_weights, __pyx_v_max_var, __pyx_v_tol);
...
static PyObject *__pyx_pf_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_4SetPointsAndWeights(struct __pyx_obj_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D *__pyx_v_self, PyArrayObject *__pyx_v_points, PyArrayObject *__pyx_v_weights, PyArrayObject *__pyx_v_max_var, double __pyx_v_tol) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_max_var;
  __Pyx_Buffer __pyx_pybuffer_max_var;
  ...
  size_t __pyx_t_6;
  __Pyx_RefNannySetupContext("SetPointsAndWeights", 0);
  __Pyx_TraceCall("SetPointsAndWeights", __pyx_f[0], 54, 0, __PYX_ERR(0, 54, __pyx_L1_error));
  ...
  __pyx_pybuffer_max_var.pybuffer.buf = NULL;
  __pyx_pybuffer_max_var.refcount = 0;
  __pyx_pybuffernd_max_var.data = NULL;
  __pyx_pybuffernd_max_var.rcbuffer = &__pyx_pybuffer_max_var;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_points.rcbuffer->pybuffer, (PyObject*)__pyx_v_points, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 54, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_weights.rcbuffer->pybuffer, (PyObject*)__pyx_v_weights, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 54, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_max_var.rcbuffer->pybuffer, (PyObject*)__pyx_v_max_var, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 54, __pyx_L1_error)
  }
  __pyx_pybuffernd_max_var.diminfo[0].strides = __pyx_pybuffernd_max_var.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_max_var.diminfo[0].shape = __pyx_pybuffernd_max_var.rcbuffer->pybuffer.shape[0];

  /* "VineGaussianKernelDensity/compiled_utilities.pyx":59
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_1 < 0) {
    __pyx_t_1 += __pyx_pybuffernd_points.diminfo[0].shape;
    if (unlikely(__pyx_t_1 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_1 >= __pyx_pybuffernd_points.diminfo[0].shape)) __pyx_t_2 = 0;
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_3 < 0) {
    __pyx_t_3 += __pyx_pybuffernd_weights.diminfo[0].shape;
    if (unlikely(__pyx_t_3 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_3 >= __pyx_pybuffernd_weights.diminfo[0].shape)) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 59, __pyx_L1_error)
  }

  /* "VineGaussianKernelDensity/compiled_utilities.pyx":60
 *                             double tol=1e-8):
 *         self.c_wgkde.SetPointsAndWeightsAdaptive(&points[0], &weights[0],
 *                                                  &max_var[0], points.size,             # <<<<<<<<<<<<<<
 *                                                  tol)
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_4 < 0) {
    __pyx_t_4 += __pyx_pybuffernd_max_var.diminfo[0].shape;
    if (unlikely(__pyx_t_4 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_4 >= __pyx_pybuffernd_max_var.diminfo[0].shape)) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 60, __pyx_L1_error)
  }
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_points), __pyx_n_s_size); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyInt_As_size_t(__pyx_t_5); if (unlikely((__pyx_t_6 == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 60, __pyx_L1_error)
 ...
 */
  try {
    __pyx_v_self->c_wgkde->SetPointsAndWeightsAdaptive((&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_points.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_points.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_weights.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_weights.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_max_var.rcbuffer->pybuffer.buf, __pyx_t_4, __pyx_pybuffernd_max_var.diminfo[0].strides))), __pyx_t_6, __pyx_v_tol);
  } catch(...) {
    __Pyx_CppExn2PyErr();
    __PYX_ERR(0, 59, __pyx_L1_error)
  }
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_max_var.rcbuffer->pybuffer);
...
/* "VineGaussianKernelDensity/compiled_utilities.pyx":62
 *                                                  &max_var[0], points.size,
 *                                                  tol)
 *     def SetPointsAndWeights(self,             # <<<<<<<<<<<<<<
 *                             np.ndarray[double, ndim=1, mode='c'] points,
...
/* Python wrapper */
static PyObject *__pyx_pw_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_7SetPointsAndWeights(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_6SetPointsAndWeights[] = "PyWeightedGaussKDE_KD_Tree_1D.SetPointsAndWeights(self, ndarray points, ndarray weights, double max_var, double tol=1e-08)";
static PyObject *__pyx_pw_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_7SetPointsAndWeights(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_points = 0;
  PyArrayObject *__pyx_v_weights = 0;
  double __pyx_v_max_var;
  double __pyx_v_tol;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("SetPointsAndWeights (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_weights)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("SetPointsAndWeights", 0, 3, 4, 1); __PYX_ERR(0, 62, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_max_var)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("SetPointsAndWeights", 0, 3, 4, 2); __PYX_ERR(0, 62, __pyx_L3_error)
        }
        case  3:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_tol);
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "SetPointsAndWeights") < 0)) __PYX_ERR(0, 62, __pyx_L3_error)
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  4: values[3] = PyTuple_GET_ITEM(__pyx_args, 3);
    ...
    __pyx_v_points = ((PyArrayObject *)values[0]);
    __pyx_v_weights = ((PyArrayObject *)values[1]);
    __pyx_v_max_var = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_max_var == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 65, __pyx_L3_error)
    if (values[3]) {
      __pyx_v_tol = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_tol == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 66, __pyx_L3_error)
    } else {
      __pyx_v_tol = ((double)1e-8);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("SetPointsAndWeights", 0, 3, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 62, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("VineGaussianKernelDensity.compiled_utilities.PyWeightedGaussKDE_KD_Tree_1D.SetPointsAndWeights", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_points), __pyx_ptype_5numpy_ndarray, 1, "points", 0))) __PYX_ERR(0, 63, __pyx_L1_error)
  ...
  __pyx_r = __pyx_pf_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_6SetPointsAndWeights(((struct __pyx_obj_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D *)__pyx_v_self), __pyx_v_points, __pyx_v_weights, __pyx_v_max_var, __pyx_v_tol);
...
static PyObject *__pyx_pf_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_6SetPointsAndWeights(struct __pyx_obj_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D *__pyx_v_self, PyArrayObject *__pyx_v_points, PyArrayObject *__pyx_v_weights, double __pyx_v_max_var, double __pyx_v_tol) {
  ...
  size_t __pyx_t_5;
  __Pyx_RefNannySetupContext("SetPointsAndWeights", 0);
  __Pyx_TraceCall("SetPointsAndWeights", __pyx_f[0], 62, 0, __PYX_ERR(0, 62, __pyx_L1_error));
  __pyx_pybuffer_points.pybuffer.buf = NULL;
  __pyx_pybuffer_points.refcount = 0;
  __pyx_pybuffernd_points.data = NULL;
  __pyx_pybuffernd_points.rcbuffer = &__pyx_pybuffer_points;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_points.rcbuffer->pybuffer, (PyObject*)__pyx_v_points, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 62, __pyx_L1_error)
  }
  __pyx_pybuffernd_points.diminfo[0].strides = __pyx_pybuffernd_points.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_points.diminfo[0].shape = __pyx_pybuffernd_points.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_weights.rcbuffer->pybuffer, (PyObject*)__pyx_v_weights, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 62, __pyx_L1_error)
  }
  __pyx_pybuffernd_weights.diminfo[0].strides = __pyx_pybuffernd_weights.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_weights.diminfo[0].shape = __pyx_pybuffernd_weights.rcbuffer->pybuffer.shape[0];

  /* "VineGaussianKernelDensity/compiled_utilities.pyx":67
 *                             double max_var,
 *                             double tol=1e-8):
 ...
 */
  ...
  /* "VineGaussianKernelDensity/compiled_utilities.pyx":68
 *                             double tol=1e-8):
 *         self.c_wgkde.SetPointsAndWeightsGlobal(&points[0], &weights[0],
 *                                                max_var, points.size,             # <<<<<<<<<<<<<<
 *                                                tol)
 ...
 */
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_points), __pyx_n_s_size); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyInt_As_size_t(__pyx_t_4); if (unlikely((__pyx_t_5 == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 68, __pyx_L1_error)
 ...
 */
  try {
    __pyx_v_self->c_wgkde->SetPointsAndWeightsGlobal((&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_points.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_points.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_weights.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_weights.diminfo[0].strides))), __pyx_v_max_var, __pyx_t_5, __pyx_v_tol);
  } catch(...) {
    __Pyx_CppExn2PyErr();
    __PYX_ERR(0, 67, __pyx_L1_error)
  }
...
static PyObject *__pyx_tp_new_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D(PyTypeObject *t, PyObject *a, PyObject *k) {
  PyObject *o;
  ...
  if (unlikely(__pyx_pw_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_1__cinit__(o, a, k) < 0)) goto bad;
  return o;
  bad:
  Py_DECREF(o); o = 0;
  return NULL;
...
static void __pyx_tp_dealloc_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D(PyObject *o) {
  ...
  #endif
  {
    ...
    ++Py_REFCNT(o);
    __pyx_pw_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_3__dealloc__(o);
    --Py_REFCNT(o);
...
static PyMethodDef __pyx_methods_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D[] = {
  {"SetPointsAndWeights", (PyCFunction)__pyx_pw_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_5SetPointsAndWeights, METH_VARARGS|METH_KEYWORDS, __pyx_doc_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_4SetPointsAndWeights},
  {"SetPointsAndWeights", (PyCFunction)__pyx_pw_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_7SetPointsAndWeights, METH_VARARGS|METH_KEYWORDS, __pyx_doc_25VineGaussianKernelDensity_18compiled_utilities_29PyWeightedGaussKDE_KD_Tree_1D_6SetPointsAndWeights},
  {0, 0, 0, 0}
};

static PyTypeObject __pyx_type_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D = {
  PyVarObject_HEAD_INIT(0, 0)
  "VineGaussianKernelDensity.compiled_utilities.PyWeightedGaussKDE_KD_Tree_1D", /*tp_name*/
  sizeof(struct __pyx_obj_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  #if PY_MAJOR_VERSION < 3
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_max_leaf, __pyx_k_max_leaf, sizeof(__pyx_k_max_leaf), 0, 0, 1, 1},
  {&__pyx_n_s_max_var, __pyx_k_max_var, sizeof(__pyx_k_max_var), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcompiled_utilities(void); /*proto*/
PyMODINIT_FUNC initcompiled_utilities(void)
#else
PyMODINIT_FUNC PyInit_compiled_utilities(void); /*proto*/
PyMODINIT_FUNC PyInit_compiled_utilities(void)
#endif
{
  __Pyx_TraceDeclarations
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_compiled_utilities(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("compiled_utilities", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_VineGaussianKernelDensity__compiled_utilities) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "VineGaussianKernelDensity.compiled_utilities")) {
      if (unlikely(PyDict_SetItemString(modules, "VineGaussianKernelDensity.compiled_utilities", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D) < 0) __PYX_ERR(0, 47, __pyx_L1_error)
  __pyx_type_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "PyWeightedGaussKDE_KD_Tree_1D", (PyObject *)&__pyx_type_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D) < 0) __PYX_ERR(0, 47, __pyx_L1_error)
  __pyx_ptype_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D = &__pyx_type_25VineGaussianKernelDensity_18compiled_utilities_PyWeightedGaussKDE_KD_Tree_1D;
  /*--- Type import code ---*/
  ...
  #endif
  __Pyx_TraceCall("PyMODINIT_FUNC PyInit_compiled_utilities(void)", __pyx_f[0], 1, 0, __PYX_ERR(0, 1, __pyx_L1_error));

  /* "VineGaussianKernelDensity/compiled_utilities.pyx":4
 ...
 */
  ...
  /* "VineGaussianKernelDensity/compiled_utilities.pyx":7
 * cimport numpy as np
 * 
 * np.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "VineGaussianKernelDensity/compiled_utilities.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init VineGaussianKernelDensity.compiled_utilities", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init VineGaussianKernelDensity.compiled_utilities");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
